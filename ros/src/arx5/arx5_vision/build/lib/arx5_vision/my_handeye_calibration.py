...
class MyHandeyeCalibrationParameters(object):
    def __init__(self, namespace, move_group_namespace='/', move_group='manipulator', eye_on_hand=None,
        ...
        """
        Creates a MyHandeyeCalibrationParameters object.
    ...
    def init_from_parameter_server(namespace):
        ...
        ret = MyHandeyeCalibrationParameters(namespace=namespace,
    ...
    def from_dict(in_dict):
        return MyHandeyeCalibrationParameters(**in_dict)
...
class MyHandeyeCalibration(object):
    """
    ...
    # TODO: use the MyHandeyeCalibration message instead, this should be MyHandeyeCalibrationConversions
    def __init__(self,
                 calibration_parameters=None,
                 transformation=None):
        """
        Creates a MyHandeyeCalibration object.
        ...
        :return: a MyHandeyeCalibration object

        :rtype: easy_handeye.handeye_calibration.MyHandeyeCalibration
        """
    ...
    def to_dict(calibration):
        ...
        """
        ret = {
            'parameters': MyHandeyeCalibrationParameters.to_dict(calibration.parameters),
            'transformation': {
    ...
    def from_dict(in_dict):
        ...
        ret = MyHandeyeCalibration(calibration_parameters=MyHandeyeCalibrationParameters.from_dict(in_dict['parameters']),
    ...
    def to_yaml(calibration):
        ...
        :rtype: string
        """
        return yaml.dump(MyHandeyeCalibration.to_dict(calibration), default_flow_style=False)
    ...
    def from_yaml(in_yaml):
        ...
        :rtype: None
        """
        return MyHandeyeCalibration.from_dict(yaml.safe_load(in_yaml))
    ...
    def init_from_parameter_server(namespace):
        ...
        params = MyHandeyeCalibrationParameters.init_from_parameter_server(namespace)

        ret = MyHandeyeCalibration(calibration_parameters=params,
                                 transformation=((
    ...
    def store_to_parameter_server(calibration):
        ...
        MyHandeyeCalibrationParameters.store_to_parameter_server(calibration.parameters)
    ...
    def filename(self):
        return MyHandeyeCalibration.filename_for_namespace(self.parameters.namespace)

    @staticmethod
    def filename_for_namespace(namespace):
        return MyHandeyeCalibration.DIRECTORY + '/' + namespace.rstrip('/').split('/')[-1] + '.yaml'
    ...
    def to_file(calibration):
        ...
        :rtype: None
        """
        if not os.path.exists(MyHandeyeCalibration.DIRECTORY):
            os.makedirs(MyHandeyeCalibration.DIRECTORY)

        with open(calibration.filename(), 'w') as calib_file:
            calib_file.write(MyHandeyeCalibration.to_yaml(calibration))
    ...
    def from_file(namespace):
        ...
        with open(MyHandeyeCalibration.filename_for_namespace(namespace)) as calib_file:
            return MyHandeyeCalibration.from_yaml(calib_file.read())
