...
ros_interface::ros_interface()
{
    ...
    _joint_states_publisher  = nh_private.advertise<sensor_msgs::JointState>("/arx5/joint_states", 10);

    // 从ROS中获取参数
    nh_private.getParam("/arx5/torque_gain",torque_gain);
    nh_private.getParam("/arx5/torque_max",torque_max);
    nh_private.getParam("/arx5/torque_filter",torque_filter);
